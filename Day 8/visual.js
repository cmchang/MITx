...
var chart = d3Chart4(); //in console, call chart.goGrouped() to animate graph
function d3Chart4(){ //vertical bar graph
    var exports = {};
    var outer_width = 300;
    ...
    var y_scale = d3.scale.linear().domain([0, y_stacked_max]).range([chart_height, 0]);
    ...
    function goGrouped(){
        ...
        rects.transition()
            ...
            .attr('x', function(d,i, j){ //j is the index in the outer array (0-3)
...
function d3Chart3(){ //vertical bar graph
    myData = data[0].map(function(d) {return d.y;});
    var outer_width = 300;
    var outer_height = 300;
